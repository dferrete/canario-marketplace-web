...
export default function AdminAuctionsPage() {
    return (
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-500 h-full min-h-[600px] flex flex-col items-center justify-center text-center p-8">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-2">Gestão de Leilões</h1>
            <p className="text-muted-foreground max-w-md mx-auto mb-8">
                Monitore lances bidirecionais e intervenha moderando salas de leilão ativas.
            </p>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 max-w-md w-full flex items-start gap-4 text-left">
                ...
                <div>
                    <h3 className="font-semibold text-amber-900">Módulo Multimodal: Leilão</h3>
                    <p className="text-sm text-amber-700 mt-1">
                        Este módulo será desenvolvido na Fase 2 do projeto, onde a API implementará concorrência elástica para Lances (Bids).
                    </p>
                </div>
            </div>
        </div>
